    ...
    <div class="about">
        <div class="contact">
            <form action="action_page.php" method="">
                ...
                <input class="email" type="text" id="lname" name="lastname" placeholder="Nhập email...">
                <label for="subject">Comment</label>
                <textarea id="subject" name="subject" placeholder="Nhập nội dung-câu hỏi?" style="height:200px"></textarea>
            </form>
        </div>
    </div>
    <div class="map">
        <div class="map1" style=" margin-top: 30px;">
        <label for="lname" style="margin-bottom: 10px;"> <i style="margin-right: 10px;" class='fas fa-map-marked'></i><span>Số 168 Thượng Đình - Thanh Xuân - Hà Nội</span> </label>
        ...
        <label for="lname" style="margin-bottom: 10px;"><i style="margin-right: 10px;" class='fas fa-map-marked'></i><span>294 - 296 Đồng Đen - Quận Tân Bình - Hồ Chí Minh</span></label>
        ...
        <label for="lname" style="margin-bottom: 10px;"><i style="margin-right: 10px;" class='fas fa-map-marked'></i><span>149-150 Thảo Nguyên- Ecopark -Hưng Yên</span> </label>
